// copied from https://raw.githubusercontent.com/ozh/github-colors/master/colors.json
const languageColorCodes = {
...
export default languageColorCodes;

export type Languages = keyof typeof languageColorCodes;
